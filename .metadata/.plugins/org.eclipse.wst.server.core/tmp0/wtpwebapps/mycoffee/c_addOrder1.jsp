...
<form action="c_OrderConfirm.jsp" method="post">
      ...
      <footer>
          <div class="wrapper">
              ...
              <p><small><a href="b_logindex.jsp"><span style="color:orange;">員工登入</span></a></small></p>
          </div>
      </footer>
